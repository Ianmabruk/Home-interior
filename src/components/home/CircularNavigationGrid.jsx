...
export const CircularNavigationGrid = memo(({ portfolio = [], virtualDesigns = [], services = [], products = [], about = null, aboutImages = [], socialItems = [], blog = [], testimonials = [], workWithUs = [], shopWithUsHomepageImage = null }) => {
  const data = useMemo(() => ({
    portfolio,
    virtualDesigns,
    services,
