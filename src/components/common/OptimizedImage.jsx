...
export default function OptimizedImage({ src, alt = '', className = '', sizes, width, loading = 'lazy', priority = false, style = {}, objectPosition = 'center', objectFit = 'cover', crop = 'limit' }) {
  ...
  const optimized = getOptimizedUrlAutoDpr(src, { width: width || 800, crop })
