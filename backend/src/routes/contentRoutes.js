...
portfolioRoutes.post('/', authenticate, authorize('ADMIN'), uploadFields([{ name: 'media', maxCount: 1 }, { name: 'gallery', maxCount: 21 }, { name: 'before', maxCount: 25 }, { name: 'after', maxCount: 25 }, { name: 'homepageCircularImage', maxCount: 1 }]), validateZod(portfolioSchemas.create), portfolioController.create)
portfolioRoutes.patch('/:id', authenticate, authorize('ADMIN'), uploadFields([{ name: 'media', maxCount: 1 }, { name: 'gallery', maxCount: 21 }, { name: 'before', maxCount: 25 }, { name: 'after', maxCount: 25 }, { name: 'homepageCircularImage', maxCount: 1 }]), validateZod(portfolioSchemas.update), portfolioController.update)
