...
portfolioRoutes.post('/', authenticate, authorize('ADMIN'), uploadFields([{ name: 'media', maxCount: 1 }, { name: 'gallery', maxCount: 35 }, { name: 'before', maxCount: 35 }, { name: 'after', maxCount: 35 }, { name: 'homepageCircularImage', maxCount: 1 }]), validateZod(portfolioSchemas.create), portfolioController.create)
portfolioRoutes.patch('/:id', authenticate, authorize('ADMIN'), uploadFields([{ name: 'media', maxCount: 1 }, { name: 'gallery', maxCount: 35 }, { name: 'before', maxCount: 35 }, { name: 'after', maxCount: 35 }, { name: 'homepageCircularImage', maxCount: 1 }]), validateZod(portfolioSchemas.update), portfolioController.update)
