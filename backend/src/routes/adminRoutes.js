...
router.post('/portfolio', uploadFields([{ name: 'media', maxCount: 1 }, { name: 'before', maxCount: 30 }, { name: 'after', maxCount: 30 }, { name: 'homepageCircularImage', maxCount: 1 }]), portfolioController.create)
router.patch('/portfolio/:id', uploadFields([{ name: 'media', maxCount: 1 }, { name: 'before', maxCount: 30 }, { name: 'after', maxCount: 30 }, { name: 'homepageCircularImage', maxCount: 1 }]), portfolioController.update)
