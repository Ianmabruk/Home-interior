...
export default async () => {
  console.log('[globalTeardown] Cleaning up and disconnecting...')
  try {
    await cleanupTestData()
    await prisma.$disconnect()
    await disconnectRedis()
    console.log('[globalTeardown] Database and Redis disconnected')
  } catch (err) {
    console.error('[globalTeardown] Error:', err?.message || err)
  }
}
